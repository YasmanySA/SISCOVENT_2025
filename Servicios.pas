...
uses
  ...
  Vcl.NumberBox, DateUtils, cxImage, Vcl.ExtDlgs, cxImageComboBox, dxSkinWXI;
...
type
  TClasificador = class(TForm)
    ...
    DStype_gasto: TUniDataSource;
    dxLayoutItem6: TdxLayoutItem;
    edTipoProducto: TcxTextEdit;
    dxLayoutItem7: TdxLayoutItem;
    btAñadir: TcxButton;
    q_InsertTypeProducto: TUniQuery;
...
uses DataClasif, ConexionDM, DataClasif_U, tasaactual, DCaja;
{$R *.dfm}
...
begin
  ...
  DM_Clasif_E.TbdescripCodigoProducto.Text := code +
    IntToStr(CalculoDigitoControlEAN(code));
  DM_Clasif_E.Tbdescrip.post;
  // ShowMessage(code + IntToStr(CalculoDigitoControlEAN(code)));
